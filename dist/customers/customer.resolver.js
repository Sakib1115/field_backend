...
let CustomerResolver = class CustomerResolver {
    ...
    async post(id) {
        return this.prisma.order.findUnique({ where: { id: id.customerId } });
    }
    async author(customer) {
        return this.prisma.order.findUnique({ where: { id: customer.id } }).author();
    }
};
__decorate([
...
], CustomerResolver.prototype, "postCreated", null);
__decorate([
...
], CustomerResolver.prototype, "createPost", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CustomerResolver.prototype, "publishedPosts", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], CustomerResolver.prototype, "userPosts", null);
__decorate([
    (0, graphql_1.Query)(() => customer_model_1.Customer),
    __param(0, (0, graphql_1.Args)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [post_id_args_1.CustomerIdArgs]),
    __metadata("design:returntype", Promise)
], CustomerResolver.prototype, "post", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CustomerResolver.prototype, "author", null);
